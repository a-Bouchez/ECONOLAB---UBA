...
//Mercado de Bienes//
  ...
  parameter Real stockoptimo=100;//"Existencias óptimas"
  parameter Real vp=0.0001;//"Velocidad de ajuste de precios a desajustes de stock"
...
//Mercado de dinero//
  ...
  Real P(start=1);//"Índice de precios"
